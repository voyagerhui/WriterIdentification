...
#           save to trn/chinese character, tst/chinese character, val/chinese character (8:1:1)
...
if __name__ == '__main__':
    ...
    for image, tagcode, file_name in read_from_gnt_dir(gnt_dir):
        ...
        if os.path.exists(pic_dir + '/trn/' + tagcode_unicode):
            newfilepath = pic_dir + '/trn/' + tagcode_unicode + '/' + file_name[:-6] + tagcode_unicode + '.png'
        elif os.path.exists(pic_dir + '/tst/' + tagcode_unicode):
            newfilepath = pic_dir + '/tst/' + tagcode_unicode + '/' + file_name[:-6] + tagcode_unicode + '.png'
        elif os.path.exists(pic_dir + '/val/' + tagcode_unicode):
            newfilepath = pic_dir + '/val/' + tagcode_unicode + '/' + file_name[:-6] + tagcode_unicode + '.png'
        else:
            r_num = random.randint(1,100)
            if r_num < 81:
                os.makedirs(pic_dir + '/trn/' + tagcode_unicode)
                newfilepath = pic_dir + '/trn/' + tagcode_unicode + '/' + file_name[:-6] + tagcode_unicode + '.png'
            elif r_num > 90:
                os.makedirs(pic_dir + '/tst/' + tagcode_unicode)
                newfilepath = pic_dir + '/tst/' + tagcode_unicode + '/' + file_name[:-6] + tagcode_unicode + '.png'
            else:
                os.makedirs(pic_dir + '/val/' + tagcode_unicode)
                newfilepath = pic_dir + '/val/' + tagcode_unicode + '/' + file_name[:-6] + tagcode_unicode + '.png'
